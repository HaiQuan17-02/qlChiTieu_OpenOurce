                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Nhập thông tin tài khoản để nhận liên kết đặt lại mật khẩu</p>
                        </div>

                        <?= displayFlashMessage() ?>

                        <form method="POST" action="<?= SITE_URL ?>/handler/password_reset_handler.php?action=request">
                            <div class="mb-3">
